  		...
  		<div id="content_box">
                ...
                <div id="content_right">
                	<div id="content_rightbox1">
								...
								<h2 class="head3" style="border-bottom:2px solid #dd6a2a; height:auto; font-size:20px;">
							...
							<div class="message_box">
									<h2 class="head3" style=" margin-top:5px; margin-left:5px; font-size:16px; line-height:1.4;">
											...
											<br/>
											Feedback : <span style="color:#e16428; font-weight:normal;"><?php echo $row['feedback'];?></span>
									</h2>		
							</div>  
							<?php
								}
