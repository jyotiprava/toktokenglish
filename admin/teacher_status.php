...
function status(val1,slno) {
    ...
    if (r == true) {
	$.ajax({url:"ajax_teacherstatus.php?id="+val1+"&uid="+slno,
						...
						<div id="content1">
								...
								<div id="content2" style="min-height:350px;">
									...
									<table class="table1">
                                                                            ...
                                                                            <?php
                                                                            $qwe=mysql_query("select * from `teacher_login`")or die(mysql_error());
									            ...
									            <select id="status<?php echo $res['slno'];?>" onchange="return status(this.value,<?php echo $res['slno'];?>);">
